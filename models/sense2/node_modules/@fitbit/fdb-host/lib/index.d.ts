...
export declare class Host extends EventEmitter {
    ...
    setInstallHandler: (installHandler: InstallHandler, installOptions?: InstallOptions) => void;
    ...
    handleSerializationChange: ({ serialization, }: FDBTypes.ProtocolSerializationChangeNotification) => void;
