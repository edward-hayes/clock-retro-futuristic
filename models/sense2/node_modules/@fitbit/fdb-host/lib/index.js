...
const ConfigurableDecode_1 = require("./ConfigurableDecode");
class Host extends events_1.EventEmitter {
    constructor(hostInfo, timeout) {
        ...
        this.deserializerTransform = new ConfigurableDecode_1.default();
        ...
        this.handleSerializationChange = ({ serialization, }) => {
        ...
        this.dispatcher
            ...
            .notification('protocol.serialization.change', fdb_protocol_1.FDBTypes.ProtocolSerializationChangeNotification, this.handleSerializationChange);
