...
const buildProcess = () => {
    return new Promise((resolve, reject) => {
        const buildProcess = child_process_1.default.spawn('npm', ['run-script', 'build'], {
            stdio: 'inherit',
            shell: true,
        });
...
function build(cli) {
    cli
        ...
        .action(async () => (0, exports.buildAction)(cli));
}
