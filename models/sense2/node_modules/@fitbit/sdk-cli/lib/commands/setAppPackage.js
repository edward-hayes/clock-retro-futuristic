...
const setAppPackageAction = async (cli, appContext, packagePath) => {
    try {
        ...
        const appPackage = await appContext.loadAppPackage((0, untildify_1.default)(loadPath));
...
exports.setAppPackageAction = setAppPackageAction;
function setAppPackage(stores) {
    return (cli) => {
        cli
            ...
            .hidden()
            .action(async (args) => (0, exports.setAppPackageAction)(cli, stores.appContext, args.packagePath));
    };
}
