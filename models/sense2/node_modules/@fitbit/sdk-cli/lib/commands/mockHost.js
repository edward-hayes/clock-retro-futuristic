...
function mockHost(cli) {
    ...
    async function mockHostAction(hostType, args) {
        ...
        const { closePromise, close } = await (0, mockHost_1.createMockHost)(hostType, { maxAPIVersion }, (msg) => cli.activeCommand.log(msg));
        onCancel.then(close);
        return closePromise;
    }
