...
exports.hosts = exports.RelayHost = void 0;
...
const HostsResponse = t.type({
    hosts: t.array(exports.RelayHost),
}, 'HostsResponse');
async function getConnectionURL(hostID) {
    const response = await (0, baseAPI_1.apiFetch)(`1/user/-/developer-relay/hosts/${hostID}`, {
        method: 'POST',
    })
        .then(baseAPI_1.assertAPIResponseOK)
        .then((0, fetchUtil_1.assertContentType)('text/uri-list'));
...
function createWebSocket(uri) {
    return new Promise((resolve, reject) => {
        const ws = (0, websocket_stream_1.default)(uri, { objectMode: true });
...
async function hosts() {
    const response = await (0, baseAPI_1.apiFetch)('1/user/-/developer-relay/hosts.json').then((0, baseAPI_1.decodeJSON)(HostsResponse));
