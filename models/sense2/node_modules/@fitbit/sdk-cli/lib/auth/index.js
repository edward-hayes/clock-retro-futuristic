...
function getAuthConfiguration() {
    const { apiUrl } = (0, environment_1.default)().config;
...
async function refreshToken(refreshToken) {
    const { clientId } = (0, environment_1.default)().config;
    try {
...
async function logout() {
    ...
    if (!authData)
        return;
    await Promise.all([revoke(authData.accessToken), storage_1.default.clear()]);
}
