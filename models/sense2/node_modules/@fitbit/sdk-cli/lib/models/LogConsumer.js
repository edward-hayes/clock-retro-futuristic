...
class LogConsumer {
    constructor({ appContext, hostConnections, messageFormatter, }) {
        ...
        this.registerSourceMaps = async () => {
            ...
            const sourceMapConsumers = await (0, mapValues_1.default)((0, lodash_1.default)(sourceMaps).pickBy().value(), async (maps) => (0, mapValues_1.default)(maps, async (map) => new source_map_1.SourceMapConsumer(map)));
            this.componentSourceMapConsumers = Object.assign(Object.assign({}, this.componentSourceMapConsumers), sourceMapConsumers);
        };
        this.handleLog = (message) => {
            if (this.componentSourceMapConsumers[message.emittedBy.component] &&
                this.appContext.appPackage &&
                message.emittedBy.uuid.toLowerCase() !==
                    this.appContext.appPackage.uuid.toLowerCase()) {
                return;
            }
            this.messageFormatter((0, sourceMapUtil_1.sourceMapMessage)(message, this.componentSourceMapConsumers));
        };
